package MapProject.HomePage;


import MapProject.HomePage.SideBar.SidePanelController;
import MapProject.Main.launch;
...
public class HomePageController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/MapProject/HomePage/SideBar/SidePanel.fxml"));
        ...
        btnLogout.setOnAction(e->{
        	LoadUi("/MapProject/Select/Select.fxml", root);
        });
    }
