...
public class SelectController  implements Initializable{
    ...
    @FXML
    private JFXButton btnlibraruan;
    ...
    public void initialize(URL url, ResourceBundle rb) {
    	btnlibraruan.setOnAction(e->{
    		Load("/MapProject/LoginPage/LoginPage.fxml");
    	});
    	btnreader.setOnAction(e->{
    		Load("/MapProject/HomePage/MapPage/Map.fxml");
    	});
    }  
